...
**Status: 0.3.0-beta.1 candidate. Public store distribution is pending licensing, stable signing, and store review.**

Start with [Architecture](docs/ARCHITECTURE.md), [Personalization and remaining work](docs/PERSONALIZATION.md)
and [Validation](docs/VALIDATION.md) when continuing development.
...
Read the full [English](docs/PRIVACY.md) or [Turkish](docs/PRIVACY.tr.md) privacy policy.
...
Product decisions: [docs/PRODUCT.md](docs/PRODUCT.md).
